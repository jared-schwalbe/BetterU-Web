...
public class UsersProgressController implements Serializable {
    ...
    @EJB
    private com.mycompany.sessionbeanpackage.UsersProgressFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setUsersProgressPK(new com.mycompany.entitypackage.UsersProgressPK());
    }
    ...
    public UsersProgress getUsersProgress(com.mycompany.entitypackage.UsersProgressPK id) {
    ...
    public static class UsersProgressControllerConverter implements Converter {
        ...
        com.mycompany.entitypackage.UsersProgressPK getKey(String value) {
            com.mycompany.entitypackage.UsersProgressPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.entitypackage.UsersProgressPK();
            key.setUid(Integer.parseInt(values[0]));
            key.setPid(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.mycompany.entitypackage.UsersProgressPK value) {
